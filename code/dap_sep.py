...
# Data specifications
parser.add_argument('--input_mix', type=str, default='data/sep/violin_basketball.wav',
                    help='input sound mixture')
parser.add_argument('--output', type=str, default='output/sep',
                    help='results')
args = parser.parse_args()


class Separation(object):
    def __init__(self, image_name, output_path, image, phase, audRate, numSeg, plot_during_training=True, show_every=500, ckpt="ckpt", num_iter=5000,
